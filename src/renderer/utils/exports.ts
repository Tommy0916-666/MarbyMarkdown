...
const ACTIVE_EDITOR_SELECTOR = '.marbymarkdown-editor-instance[data-active="true"] .marbymarkdown-container';
...
export async function exportElementWithStylesAndImages(
  ...
  <head>
    ...
    <style>
      ...
      .export-container > .marbymarkdown-container {
        width: 100%!important;
      }
      .export-container > .marbymarkdown-container .marbymarkdown-editor,.export-container > .marbymarkdown-container .marbymarkdown-editor > div[contenteditable="true"] {
        width: 100%!important;
      }
      p {
