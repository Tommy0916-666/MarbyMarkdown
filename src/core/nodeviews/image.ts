...
export class ImageView implements NodeView {
  ...
  private initSourceViewMode(): void {
    ...
    this.sourceTextElement.className = "marbymarkdown-image-source-text";
  ...
  private renderImage(src: string, alt: string, title?: string, linkHref?: string): void {
    ...
    // 将相对路径转为 marbymarkdown:// 协议 URL 仅用于 DOM 渲染
  ...
  private showImageError(src: string): void {
    ...
    placeholder.className = "marbymarkdown-image-placeholder marbymarkdown-image-error-placeholder";
    placeholder.innerHTML = `
      <span class="marbymarkdown-image-placeholder-icon">🖼️</span>
      <span class="marbymarkdown-image-placeholder-text">图片加载失败</span>
      <span class="marbymarkdown-image-placeholder-src">${this.escapeHtml(src)}</span>
    `;
  ...
  private showImagePlaceholder(text: string): void {
    this.imgElement.innerHTML = "";
    const placeholder = document.createElement("div");
    placeholder.className = "marbymarkdown-image-placeholder";
    placeholder.innerHTML = `
      <span class="marbymarkdown-image-placeholder-icon">🖼️</span>
      <span class="marbymarkdown-image-placeholder-text">${this.escapeHtml(text)}</span>
    `;
    this.imgElement.appendChild(placeholder);
  }
