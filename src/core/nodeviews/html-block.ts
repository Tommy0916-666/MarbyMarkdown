...
export class HtmlBlockView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    this.dom.className = "marbymarkdown-html-block";
    this.applyInlineHtmlClass(node);

    // 创建 header（固定显示 "HTML"）
    this.header = document.createElement("div");
    this.header.className = "marbymarkdown-html-block-header";
    const label = document.createElement("span");
    label.className = "marbymarkdown-html-block-label";
    ...
    this.preview.className = "marbymarkdown-html-block-preview";
    this.dom.appendChild(this.preview);

    // 创建编辑器容器
    this.editorContainer = document.createElement("div");
    this.editorContainer.className = "marbymarkdown-html-block-editor";
