...
export const searchPluginKey = new PluginKey<SearchState>("marbymarkdown-search");
...
function scrollCurrentMatchIntoView(view: EditorView): void {
  requestAnimationFrame(() => {
    const el = view.dom.querySelector(".marbymarkdown-search-match-current");
    if (el) {
