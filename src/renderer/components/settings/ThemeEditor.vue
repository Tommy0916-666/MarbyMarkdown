...
import MarbymarkdownEditor from "@/renderer/components/editor/MarbymarkdownEditor.vue";
    ...
    <div class="editor-container">
      ...
      <div class="preview-panel">
        ...
        <div class="preview-content">
          <MarbymarkdownEditor :tab="previewTab" :is-active="true" class="preview-editor" />
        </div>
      </div>
    </div>
  </div>
