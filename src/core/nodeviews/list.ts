...
export class BulletListView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    this.dom.className = "marbymarkdown-bullet-list";
...
export class OrderedListView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    this.dom.className = "marbymarkdown-ordered-list";
...
export class ListItemView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    this.dom.className = "marbymarkdown-list-item";

    // 创建标记元素（源码模式下显示）
    this.markerElement = document.createElement("span");
    this.markerElement.className = "marbymarkdown-list-marker";
    this.updateMarker();

    // 创建内容容器
    this.contentDOM = document.createElement("div");
    this.contentDOM.className = "marbymarkdown-list-item-content";
...
export class TaskListView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    // 创建容器
    this.dom = document.createElement("ul");
    this.dom.className = "marbymarkdown-task-list";
    this.contentDOM = this.dom;
...
export class TaskItemView implements NodeView {
  ...
  constructor(node: ProseMirrorNode, view: ProseMirrorView, getPos: () => number | undefined) {
    ...
    // 创建容器
    this.dom = document.createElement("li");
    this.dom.className = "marbymarkdown-task-item";

    // 创建自定义复选框（即时渲染模式下显示）
    this.checkboxElement = document.createElement("span");
    this.checkboxElement.className = "marbymarkdown-task-checkbox";
