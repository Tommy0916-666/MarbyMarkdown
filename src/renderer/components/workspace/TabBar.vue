...
// 是否显示Tab栏（知识库模式下隐藏）
const showTabBar = computed(() => appMode.value === "editor");
// 是否显示新建按钮
const showAddButton = computed(() => appMode.value === "editor");
...
<template>
  ...
  >
    ...
    >
      ...
      <div v-if="showAddButton" key="addTab" class="addTab" @click="handleAddTab">
