...
const code_inline: MarkSpec = {
  ...
  parseDOM: [{ tag: "code" }],
  toDOM(): DOMOutputSpec {
    return ["code", { class: "marbymarkdown-code-inline" }, 0];
  },
};
...
export const marbymarkdownSchema = new Schema({
  nodes: {
    doc,
    paragraph,
    heading,
...
export type MarbymarkdownSchema = typeof marbymarkdownSchema;
