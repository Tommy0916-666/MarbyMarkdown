...
/** 插件 Key */
export const lineNumbersPluginKey = new PluginKey("marbymarkdown-line-numbers");
    ...
    if (node.isBlock) {
      ...
      if (parentIsListItem && node.type.name === "paragraph") {
        decorations.push(
          Decoration.node(pos, pos + node.nodeSize, {
            class: "marbymarkdown-with-line-number marbymarkdown-list-line-number",
          })
        );
        return false;
      }
      ...
      if (parentIsDoc || parentIsBlockquote || parentIsContainer) {
        if (node.type.name === "code_block") {
          ...
          decorations.push(
            Decoration.node(pos, pos + node.nodeSize, {
              class: "marbymarkdown-code-block-with-lines",
          ...
          decorations.push(
            Decoration.node(pos, pos + node.nodeSize, {
              class: "marbymarkdown-with-line-number",
            })
          );
        }
      }
