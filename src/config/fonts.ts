...
export const fontCssVariables = {
  'editor-font': '--marbymarkdown-font-default',
  'code-font': '--marbymarkdown-font-code',

}

export const fontSizeCssVariables = {
  'editor-font-size': '--marbymarkdown-font-size-default',
  'code-font-size': '--marbymarkdown-font-size-code',
  'editor-font-size-h1': '--marbymarkdown-font-size-h1',
  'editor-font-size-h2': '--marbymarkdown-font-size-h2',
  'editor-font-size-h3': '--marbymarkdown-font-size-h3',
  'editor-font-size-h4': '--marbymarkdown-font-size-h4',
  'editor-font-size-h5': '--marbymarkdown-font-size-h5',
  'editor-font-size-h6': '--marbymarkdown-font-size-h6',
}
