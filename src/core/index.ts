...
// 编辑器主类
export { MarbymarkdownEditor, createMilkupEditor } from "./editor";

// Schema
export { marbymarkdownSchema, type MarbymarkdownSchema } from "./schema";
...
export {
  createAIOptimizationPlugin,
  triggerAIOptimization,
  type AIOptimizationConfig,
  type AIOptimizationStyle,
  type AIOptimizationState,
} from "./plugins/ai-optimization";
...
export type {
  MarbymarkdownConfig,
  MarbymarkdownEditor as IMilkupEditor,
  MarbymarkdownPlugin,
  ImagePathProcessor,
  SyntaxType,
  SyntaxMarker,
